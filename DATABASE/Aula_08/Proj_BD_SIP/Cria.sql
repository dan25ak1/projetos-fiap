...
ALTER TABLE t_sip_dependente
    ADD CONSTRAINT ck_sip_dependente_status CHECK ( st_dependente IN (
        'ATIVO',
        'INATIVO'
    ) );

ALTER TABLE t_sip_dependente ADD CONSTRAINT pk_sip_dependente PRIMARY KEY ( id_dependente,
                                                                            cd_func );
...
ALTER TABLE t_sip_depto ADD CONSTRAINT pk_sip_depto PRIMARY KEY ( cd_depto );
...
CREATE TABLE t_sip_execucao_proj (
...
ALTER TABLE t_sip_execucao_proj ADD CONSTRAINT pk_sip_implantacao PRIMARY KEY ( cd_implantacao,
                                                                                cd_projeto );
...
ALTER TABLE t_sip_funcionario ADD CONSTRAINT pk_sip_funcionario PRIMARY KEY ( cd_func );
...
ALTER TABLE t_sip_telefone ADD CONSTRAINT pk_sip_telefone PRIMARY KEY ( cd_telefone,
                                                                        cd_func );
...
ALTER TABLE t_sip_dependente
    ADD CONSTRAINT fk_sip_func_dependente FOREIGN KEY ( cd_func )
        REFERENCES t_sip_funcionario ( cd_func );

ALTER TABLE t_sip_funcionario_endereco
    ADD CONSTRAINT fk_sip_func_endereco FOREIGN KEY ( cd_func )
        REFERENCES t_sip_funcionario ( cd_func );

ALTER TABLE t_sip_execucao_proj
    ADD CONSTRAINT fk_sip_func_exec_proj FOREIGN KEY ( cd_func )
        REFERENCES t_sip_funcionario ( cd_func );

ALTER TABLE t_sip_telefone
    ADD CONSTRAINT fk_sip_func_telefone FOREIGN KEY ( cd_func )
        REFERENCES t_sip_funcionario ( cd_func );

ALTER TABLE t_sip_execucao_proj
    ADD CONSTRAINT fk_sip_proj_exec_proj FOREIGN KEY ( cd_projeto )
...
ALTER TABLE T_sip_TELEFONE ADD TP_TELEFONE NUMBER(1);
ALTER TABLE T_sip_TELEFONE MODIFY NR_TELEFONE NUMBER(9);
